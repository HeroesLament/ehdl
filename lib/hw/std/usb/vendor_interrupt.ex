defmodule Hw.USB.VendorInterrupt do
  @moduledoc """
  USB vendor-class device, interrupt IN/OUT endpoints (bring-up copy of the CDC enum engine).
  ...
  comb do
    ...
    desc_cap    = if req_val_hi == 0x01, do: 18, else: 32
    ...
    hdl_case <<desc_addr_next::7>> do
      ...
      <<4::7>> -> desc_byte_next = 0xFF
      <<7::7>> -> desc_byte_next = 0x40
      <<8::7>> -> desc_byte_next = 0x09
      <<9::7>> -> desc_byte_next = 0x12
      <<10::7>> -> desc_byte_next = 0x02
      <<13::7>> -> desc_byte_next = 0x01
      <<17::7>> -> desc_byte_next = 0x01
      <<18::7>> -> desc_byte_next = 0x09
      <<19::7>> -> desc_byte_next = 0x02
      <<20::7>> -> desc_byte_next = 0x20
      <<22::7>> -> desc_byte_next = 0x01
      <<23::7>> -> desc_byte_next = 0x01
      <<25::7>> -> desc_byte_next = 0x80
      <<26::7>> -> desc_byte_next = 0x32
      <<27::7>> -> desc_byte_next = 0x09
      <<28::7>> -> desc_byte_next = 0x04
      <<31::7>> -> desc_byte_next = 0x02
      <<32::7>> -> desc_byte_next = 0xFF
      <<36::7>> -> desc_byte_next = 0x07
      <<37::7>> -> desc_byte_next = 0x05
      <<38::7>> -> desc_byte_next = 0x01
      <<39::7>> -> desc_byte_next = 0x03
      <<40::7>> -> desc_byte_next = 0x40
      <<42::7>> -> desc_byte_next = 0x01
      <<43::7>> -> desc_byte_next = 0x07
      <<44::7>> -> desc_byte_next = 0x05
      <<45::7>> -> desc_byte_next = 0x82
      <<46::7>> -> desc_byte_next = 0x03
      <<47::7>> -> desc_byte_next = 0x40
      <<49::7>> -> desc_byte_next = 0x01
