#!/usr/bin/env elixir
# designs/can_controller_bringup/build.exs
#
# Usage:
#   mix run designs/can_controller_bringup/build.exs               # build + load to SRAM (volatile)
#   mix run designs/can_controller_bringup/build.exs --flash       # build + write SPI flash (persistent)
#   mix run designs/can_controller_bringup/build.exs --build-only  # build the .bit only, don't touch the board
#
...
defmodule CanControllerBringup.Build do
  @build_dir "designs/can_controller_bringup/build"
  @top_module CanControllerBringup.Top
  @modules [CanControllerBringup.Top]
  @lpf_file "lib/hw/boards/ulx3s/ulx3s_v20_nextpnr.lpf"
  @top_name "can_controller_bringup"
...
CanControllerBringup.Build.run(System.argv())
